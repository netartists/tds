...
function mc4wp_get_options( $key = '' ) {
	...
	if( null === $options ) {
		...
		$email_label = __( 'Subscribe to our newsletter', 'mailchimp-for-wp' );
		$email_desc = __( 'The best of Financial Bureau materials, delivered weekly.', 'mailchimp-for-wp' );

				...
				jQuery(window).load(function() {
					jQuery('#flexslider_<?php echo $random ?>').flexslider({
						...
						<?php if($direction_nav) { ?>
							...
							start: function() {
								var firstImageHeight = $("#flexslider_<?php echo $random ?> a > img").first().height();
								activeImageCenter = firstImageHeight / 2;
								navObject = jQuery('#flexslider_<?php echo $random ?>').find("ul.flex-direction-nav li a");
								navObject.animate({"top":activeImageCenter - 20}, 200);
							}
						<?php } ?>
					});					
				...
				<?php if($direction_nav) { ?>
					jQuery(document).ready(function() {
						jQuery(window).resize(
							function(){
								activeImage = jQuery('#flexslider_<?php echo $random ?>').find('.flex-viewport .flex-active-slide .thumbnail img');
								activeImageCenter = activeImage.height() / 2;
								navObject = jQuery('#flexslider_<?php echo $random ?>').find("ul.flex-direction-nav li a");
								navObject.animate({"top":activeImageCenter - 20}, 200);
							}
						).trigger('resize');

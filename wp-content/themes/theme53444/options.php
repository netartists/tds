...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '28px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#222222'));

			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '48px', 'lineheight' => '58px', 'face' => 'Open Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#222222'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '36px', 'lineheight' => '43px', 'face' => 'Open Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#222222'));

			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '30px', 'lineheight' => '36px', 'face' => 'Open Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#222222'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '26px', 'lineheight' => '31px', 'face' => 'Open Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#222222'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '21px', 'lineheight' => '25px', 'face' => 'Open Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#222222'));

			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '19px', 'lineheight' => '24px', 'face' => 'Open Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#222222'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '30px', 'lineheight' => '36px', 'face' => 'Open Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#474747'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '19px', 'lineheight' => '22px', 'face' => 'Open Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#474747'));
...
// ---------------------------------------------------------
			...
			$options['footer_text'] = array(
								"id" => "footer_text",
								"std" => "Aenean in dui in neque mollis tempor");
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '13px', 'lineheight' => '16px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#9788a9'));
...
// ---------------------------------------------------------
		...
		$options['linkedin'] = array(
							"name" => __('LinkedIn URL', CURRENT_THEME),
